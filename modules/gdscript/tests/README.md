...
See the
[Integration tests for GDScript documentation](https://docs.blazium.app/contributing/development/core_and_modules/unit_testing.html#integration-tests-for-gdscript)
